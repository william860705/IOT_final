    ...
    render() {
        ...
        return (
            <div className='post-form'>
                <Alert color='' className={`www d-flex flex-column flex-sm-row justify-content-center ${inputDanger}`}>
                    ...
                    <Input color='#fff' className='ww' type='textarea' getRef={el => {this.inputEl = el}} value={this.state.inputValue} onChange={this.handleInputChange} placeholder="今日菜單"></Input>
                    <Button className='ddd btn-post align-self-end' onClick={this.handlePost}><FontAwesome
